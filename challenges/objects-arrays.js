...
const lowerCase = zooAnimals.map(ani => ani.animal_name.toLowerCase());
...
const populations = zooAnimals.map(ani => ani.population);
populationTotal = populations.reduce((total, amount) => total + amount); 
